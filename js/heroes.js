...
const HEROES = {
  ...
  关羽:   { name: '关羽', story: 'taoyuan', skill: 'rowClear', awakenedSkill: 'crossClear', voice: '看我温酒斩华雄', skillWord: '温酒斩雄', audio: 'guanyu.wav' },
  张飞:   { name: '张飞', story: 'taoyuan', skill: 'combo3', awakenedSkill: 'combo6', voice: '俺也一样', skillWord: '当阳断桥', audio: 'zhangfei.wav' },
