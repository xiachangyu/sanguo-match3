...
const HEROES = {
  ...
  诸葛亮: { name: '诸葛亮', story: 'sangu', skill: 'clear30', awakenedSkill: 'clearAll', voice: '鞠躬尽瘁，死而后已', skillWord: '鞠躬尽瘁', audio: 'zhugeliang.wav' },
  鲁肃:   { name: '鲁肃', story: 'caochuan', skill: 'pause5', awakenedSkill: 'pause8', voice: '以和为贵', skillWord: '以和为贵', audio: 'lusu.wav' },
  周瑜:   { name: '周瑜', story: 'chibi', skill: 'combo6', awakenedSkill: 'combo10', voice: '既生瑜，何生亮', skillWord: '既生瑜亮', audio: 'zhouyu.wav' },
